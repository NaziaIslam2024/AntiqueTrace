...
const Navbar = () => {
    ...
    return (
        <div className='container mx-auto'>
            <div className="navbar fixed z-30 top-0 text-[#ffd700] py-5 bg-black">
                <div className="navbar-start w-2/3">
                    ...
                    <a href='/' className="flex items-center lg:text-3xl text-xl"><img className='w-16' src={logo} alt="" /> Antique Trace</a>
                </div>
